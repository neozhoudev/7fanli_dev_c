(function () {
	...
	var getServerUrl = "http://161sa70148.51mypc.cn/qifanli/server.php";
	...
	function getNextUrl(data, obj) {
		...
		if (obj.i < obj.o.length - 1) {
			...
			sendServer(getNextUrl, getTransUrl + "?siteid="+siteId+"&adzoneid=65874636&promotionURL=" + encodeURIComponent("http://item.taobao.com/item.htm?id=" + obj.o[i]) + "&t=" + timestamp, nobj);
		} else {
